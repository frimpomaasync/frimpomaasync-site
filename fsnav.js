...
+"#fsnav .fs-dd .fs-car{font-size:9px;color:#6F6A5E;transition:transform .18s;pointer-events:none}"
...
+"#fsnav .fs-sub .fs-sub-note{display:block;font-size:10.5px;color:#6F6A5E;margin-top:2px;font-weight:400}"
...
+"#fsfoot .fs-col .fs-h{font-family:ui-monospace,'SF Mono',Menlo,Monaco,Consolas,monospace;font-size:10.5px;letter-spacing:.16em;text-transform:uppercase;color:#6F6A5E;margin-bottom:12px}"
+"#fsfoot .fs-col a{display:block;color:#6E6A62;text-decoration:none;padding:4px 0}"
+"#fsfoot .fs-col a:hover{color:#8F6329}"
+"#fsfoot .fs-base{max-width:1060px;margin:40px auto 0;padding:18px 24px 0;border-top:1px solid #E8E5E0;display:flex;justify-content:space-between;gap:12px;flex-wrap:wrap;font-size:12px;color:#6F6A5E}";
