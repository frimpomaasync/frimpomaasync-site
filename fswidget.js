...
var css=''
+'#sk-bubble{position:fixed;right:20px;bottom:20px;width:64px;height:64px;border-radius:50%;background:#13203A;padding:0;border:none;cursor:pointer;box-shadow:0 10px 28px -8px rgba(19,32,58,.55);z-index:9000;transition:transform .18s ease}'
...
+'.sk-head .av img{width:38px;height:38px;border-radius:10px;display:block}'
...
+'.sk-body .msg.me{background:linear-gradient(135deg,#C9975B,#8F6329);color:#fff;border-bottom-right-radius:4px;align-self:flex-end}'
+'.sk-body .msg a{color:#8F6329;font-weight:600}'
...
+'.sk-quick button{background:#fff;border:1px solid #E4C79A;color:#8F6329;font-size:12.5px;font-weight:600;padding:7px 12px;border-radius:999px;cursor:pointer;font-family:inherit}'
